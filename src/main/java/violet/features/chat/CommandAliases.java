...
public class CommandAliases {
    ...
    public static Settings buildSettings() {
        ...
        settings.setTitle(Text.literal("Command Aliases"));
        return settings;
    }
    ...
    public static class Setting extends FlowLayout {
        ...
        public Setting(int index) {
            ...
            this.aliasInput.tooltip(Text.literal("The command name of this alias. Example: /dn"));
            ...
            this.messageInput.tooltip(Text.literal("The message/command that this alias will send. Example: /warp dungeon_hub"));
