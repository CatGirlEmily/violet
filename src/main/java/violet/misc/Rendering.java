...
public final class Rendering {
    ...
    public static class Pipelines {
        ...
        public static final RenderPipeline filledNoCull = RenderPipelines.register(RenderPipeline.builder(filledSnippet)
                .withLocation(Identifier.of("violet", "pipeline/violet_filled_no_cull"))
    ...
    public static class Layers {
        public static final RenderLayer BoxFilled = RenderLayer.of("violet_box_filled", RenderSetup.builder(Pipelines.filledCull)
                .layeringTransform(LayeringTransform.VIEW_OFFSET_Z_LAYERING)
                .translucent()
                .build());
        public static final RenderLayer BoxFilledNoCull = RenderLayer.of("violet_box_filled_no_cull", RenderSetup.builder(Pipelines.filledNoCull)
                .layeringTransform(LayeringTransform.VIEW_OFFSET_Z_LAYERING)
                .translucent()
                .build());
        public static final RenderLayer BoxOutline = RenderLayer.of("violet_box_outline", RenderSetup.builder(Pipelines.outlineCull)
                .layeringTransform(LayeringTransform.VIEW_OFFSET_Z_LAYERING)
                .translucent()
                .build());
        public static final RenderLayer BoxOutlineNoCull = RenderLayer.of("violet_box_outline_no_cull", RenderSetup.builder(Pipelines.outlineNoCull)
                .layeringTransform(LayeringTransform.VIEW_OFFSET_Z_LAYERING)
                .translucent()
                .build());
        public static final RenderLayer GuiLine = RenderLayer.of("violet_gui_line", RenderSetup.builder(Pipelines.lineNoCull)
                .layeringTransform(LayeringTransform.VIEW_OFFSET_Z_LAYERING)
                .translucent()
                .build());
    }
