...
public class ToggleButton extends ButtonComponent {
    public static final MutableComponent enabledText = net.minecraft.network.chat.Component.literal("Enabled").withColor(0x55ff55);
    public static final MutableComponent disabledText = net.minecraft.network.chat.Component.literal("Disabled").withColor(0xff5555);
