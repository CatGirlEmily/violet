...
- **General**
    ...
    - **Price Tooltips**: Adds pricing information to item tooltips. Requires connectivity to the violet API.
...
- **Misc**
    ...
    - **Update Checker**: Checks if a violet update is available the first time you join any world/server.
...
- **Dungeons**
    ...
    - **Chest Value**: Calculates the value of your Dungeons loot. Requires connectivity to the violet API.
...
- **Kuudra**
    ...
    - **Chest Value**: Calculates the value of your Kuudra loot. Requires connectivity to the violet API.
...
- **Mod Commands** (accessed under `/violet`, or `/nf` for short)
    ...
    - **hudEditor**: Opens the violet hud editor.
...
- **Other Commands** (not under `/violet`)
...
**There are fake violet websites and Discord servers floating around.** Here are some general rules of thumb to help
you stay safe:
...
- Head over to the [versions page](https://modrinth.com/mod/violet/versions), download the most recent release for
...
- Additional dependencies needed to launch the mod:
    ...
    - [Mod Menu](https://modrinth.com/mod/modmenu) (Optional, settings can be accessed with `/violet`, or `/nf`)
